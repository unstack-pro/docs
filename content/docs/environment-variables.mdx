...
<Callout type="info">
Autumn is required for billing functionality.
Autumn can be fully removed if you don't need organization billing.
</Callout>
...
npx convex env set BETTER_AUTH_URL "https://dev.untraceable.dev"

# Email configuration
npx convex env set RESEND_API_KEY "RESEND API KEY"
npx convex env set EMAIL_FROM "Unstack Pro <no-reply@auth.unstack.pro>"

# Payments (required for organizations)
npx convex env set AUTUMN_API_KEY "API KEY HERE"

# Application URLs
npx convex env set NEXT_PUBLIC_APP_URL "https://dev.untraceable.dev"
npx convex env set NEXT_PUBLIC_APP_NAME "Unstack Pro"
npx convex env set SITE_URL "https://dev.untraceable.dev"

# Convex configuration
npx convex env set CONVEX_DEPLOYMENT "dev:merry-bison-13"
npx convex env set NEXT_PUBLIC_CONVEX_URL "https://merry-bison-13.convex.cloud"
npx convex env set NEXT_PUBLIC_CONVEX_SITE_URL "https://merry-bison-13.convex.site"

# Passkeys
npx convex env set PASSKEY_RP_ID "dev.untraceable.dev"
```
