...
├── autumn.ts               # Autumn SDK integration (Node/Next.js only)
...
├── debug-resend.ts         # Resend delivery debugging (needs RESEND_DEPLOY_KEY)
...
```json
{
  "scripts": {
    ...
    "demo:capture": "…",  // Playwright capture
    "demo:video": "…",    // Remotion render
    "demo:render": "…"    // capture + render
  }
}
```
